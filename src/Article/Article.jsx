...
const Article = () => {
  return (
    <article>
      ...
      <p>Not only is the Statue of Liberty the symbol of New York City, she is also a <abbr title="The United Nations Educational, Scientific and Cultural Organization">UNESCO</abbr> World Heritage site under the designation of <i>Outstanding Universal Value.</i></p>
